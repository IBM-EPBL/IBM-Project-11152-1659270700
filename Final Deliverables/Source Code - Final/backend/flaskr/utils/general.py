...
def send_confirmation_token(email):
    ...
    confirm_html = f"<h1>Welcome!!</h1><h2>Confirmation Mail from tracker</h2><p>Thanks! for signing up. Please follow this link to activate your account:</p><p><a href={confirm_url}>{confirm_url}</a></p><br><h4>Happy Spending</h4>"
